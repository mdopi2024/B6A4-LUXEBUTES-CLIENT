...
export const dynamic = "force-dynamic"; // 👈 stop static prerendering of this page
    ...
    const form = useForm({
        ...
        onSubmit: async ({ value }) => {
            ...
            try {
                ...
                if (!data.success) {
                    return toast.error(data.message || 'Failed to add new menu, please try again', { id: toastId })
                }
                toast.success(data.message || "New menu has been added", { id: toastId });
                form.reset()
            } catch (error) {
        ...
        <div className="flex justify-center items-center pt-14">
            <Card className="w-full max-w-sm mx-auto">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter menu name, description, price, image below to add a new menu
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <form
                            ...
                            <form.Field name="categoryId" children={(field) => {
                                ...
                                return (
                                    <Field>
                                        ...
                                        <Select
                                            name={field.name}
                                            // 👇 never pass "" to Radix Select — use undefined instead
