...
const ProviderAllOrderTable = ({ orders }: { orders: Orders[] }) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <td className="px-6 py-4 align-middle text-gray-600">
                                    {order.delevaryAddress}
                                </td>

                                <td className="px-6 py-4 align-middle">{order.quantity}</td>

                                <td className="px-6 py-4 align-middle font-semibold text-gray-800">
                                    ৳ {order.totalAmount}
                                </td>
                                        ...
                                        <Tooltip.Root delayDuration={300}>
                                            <Tooltip.Trigger asChild>
                                                {order.status === "CANCELLED" ? (
                                                    <span className="text-gray-300 cursor-not-allowed transition">
                                                        <FiEdit size={18} />
                                                    </span>
                                                ) : (
                                                    <Link
...
export default ProviderAllOrderTable;